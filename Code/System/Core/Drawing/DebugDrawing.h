...
namespace KRG::Drawing
{
    ...
    // Note: We use float4 for colors here since KRG::Color will implicitly convert to a float4. 
    ...
    class KRG_SYSTEM_CORE_API DrawContext
    {
    ...
    private:
        ...
        KRG_FORCE_INLINE void InternalDrawPoint( ThreadCommandBuffer& cmdList, Float3 const& position, Float4 const& color, float thickness, DepthTestState depthTestState = DepthTestState::DisableDepthTest, Seconds TTL = -1 )
        {
            cmdList.AddCommand( PointCommand( position, color, thickness, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawLine( ThreadCommandBuffer& cmdList, Float3 const& startPosition, Float3 const& endPosition, Float4 const& color, float lineThickness, DepthTestState depthTestState = DepthTestState::DisableDepthTest, Seconds TTL = -1 )
        {
            cmdList.AddCommand( LineCommand( startPosition, endPosition, color, lineThickness, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawLine( ThreadCommandBuffer& cmdList, Float3 const& startPosition, Float3 const& endPosition, Float4 const& startColor, Float4 const& endColor, float lineThickness, DepthTestState depthTestState = DepthTestState::DisableDepthTest, Seconds TTL = -1 )
        {
            cmdList.AddCommand( LineCommand( startPosition, endPosition, startColor, endColor, lineThickness, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawLine( ThreadCommandBuffer& cmdList, Float3 const& startPosition, Float3 const& endPosition, Float4 const& color, float startLineThickness, float endLineThickness, DepthTestState depthTestState = DepthTestState::DisableDepthTest, Seconds TTL = -1 )
        {
            cmdList.AddCommand( LineCommand( startPosition, endPosition, color, startLineThickness, endLineThickness, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawLine( ThreadCommandBuffer& cmdList, Float3 const& startPosition, Float3 const& endPosition, Float4 const& startColor, Float4 const& endColor, float startLineThickness, float endLineThickness, DepthTestState depthTestState = DepthTestState::DisableDepthTest, Seconds TTL = -1 )
        {
        ...
        KRG_FORCE_INLINE void InternalDrawTriangle( ThreadCommandBuffer& cmdList, Float3 const& v0, Float3 const& v1, Float3 const& v2, Float4 const& color, DepthTestState depthTestState = DepthTestState::DisableDepthTest, Seconds TTL = -1 )
        {
            cmdList.AddCommand( TriangleCommand( v0, v1, v2, color, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawTriangle( ThreadCommandBuffer& cmdList, Float3 const& v0, Float3 const& v1, Float3 const& v2, Float4 const& color0, Float4 const& color1, Float4 const& color2, DepthTestState depthTestState = DepthTestState::DisableDepthTest, Seconds TTL = -1 )
        {
            cmdList.AddCommand( TriangleCommand( v0, v1, v2, color0, color1, color2, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawText2D( ThreadCommandBuffer& cmdList, Float2 const& position, char const* pText, Float4 const& color, FontSize size, TextAlignment alignment, DepthTestState depthTestState, Seconds TTL = -1 )
        {
            cmdList.AddCommand( TextCommand( position, pText, color, size, alignment, false, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawText3D( ThreadCommandBuffer& cmdList, Float3 const& position, char const* pText, Float4 const& color, FontSize size, TextAlignment alignment, DepthTestState depthTestState, Seconds TTL = -1 )
        {
            cmdList.AddCommand( TextCommand( position, pText, color, size, alignment, false, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawTextBox2D( ThreadCommandBuffer& cmdList, Float2 const& position, char const* pText, Float4 const& color, FontSize size, TextAlignment alignment, DepthTestState depthTestState, Seconds TTL = -1 )
        {
            cmdList.AddCommand( TextCommand( position, pText, color, size, alignment, true, TTL ), depthTestState );
        }

        KRG_FORCE_INLINE void InternalDrawTextBox3D( ThreadCommandBuffer& cmdList, Float3 const& position, char const* pText, Float4 const& color, FontSize size, TextAlignment alignment, DepthTestState depthTestState, Seconds TTL = -1 )
        {
            cmdList.AddCommand( TextCommand( position, pText, color, size, alignment, true, TTL ), depthTestState);
        }
